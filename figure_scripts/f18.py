...
parser = argparse.ArgumentParser(description="Plot speedup results from a directory of JSON files.")
parser.add_argument("--dir", help="Directory containing JSON speedup files")
